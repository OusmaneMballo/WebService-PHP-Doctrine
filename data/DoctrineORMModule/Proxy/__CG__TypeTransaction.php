 ...
 */
class TypeTransaction extends \TypeTransaction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TypeTransaction' . "\0" . 'id', '' . "\0" . 'TypeTransaction' . "\0" . 'libelle', '' . "\0" . 'TypeTransaction' . "\0" . 'transaction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeTransaction $proxy) {
